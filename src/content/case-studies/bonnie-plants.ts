...
export const bonniePlantsCaseStudy: CaseStudyDetail = {
  slug: "bonnie-plants",
  liveUrl: "https://bonnieplants.com/",
  ...
  stats: [
    { metric: "100+ years", label: "gardening heritage" },
    { metric: "Herbs & veg", label: "live plant range" },
    { metric: "Ready to ship", label: "doorstep delivery" },
    { metric: "Rewards", label: "loyalty programme" },
  ],
  featureBandMatch: "product",
  sections: {
    ...
    featuresIntro:
      "Product discovery, growing resources, and seasonal merchandising built as one Shopify experience.",
    journeyEyebrow: "Shopping journey",
    journeyTitle: "From browse to backyard harvest.",
    journeyIntro:
    ...
    ctaIntro:
      "We build product-led storefronts with the category depth, educational content, and mobile experience specialty retailers actually need.",
  },
  screenshots: [
    {
      src: "/work/bonnie-plants/homepage.png",
      alt: "Bonnie Plants homepage with seasonal plant highlights and shop navigation",
      caption: "Homepage",
    ...
    },
    {
      ...
      alt: "Bonnie Plants vegetables collection with live plant product grid",
      caption: "Vegetables",
    ...
    },
    {
      ...
      alt: "Bonnie Plants Cherokee Purple heirloom tomato product page with add to cart",
    ...
    },
    {
      ...
      alt: "Bonnie Plants DIY garden projects blog archive",
    ...
    },
    {
      ...
      alt: "Bonnie Plants vertical gardening ideas article with growing tips",
    ...
    },
    {
      ...
      alt: "Bonnie Plants our story page with brand heritage",
      caption: "Our story",
  ...
  features: [
    ...
    {
      icon: "wallet",
      title: "Live plant catalogue",
      description:
        "Hundreds of varieties in multi-pack formats with clear pricing, so gardeners know exactly what they're ordering before plants ship.",
    },
    {
      icon: "instant",
    ...
    },
    {
      ...
      title: "FAQs & support",
      description:
        "Comprehensive FAQ, contact, shipping, and privacy pages that set expectations for live plant delivery and care.",
    },
    {
      icon: "admin",
  ...
  playerSteps: [
    {
      ...
      description:
        "Land from search or referral, browse seasonal highlights and trending categories, and explore herbs, vegetables, or ready-to-ship collections.",
    },
    {
      step: "02",
      title: "Find your plants",
      description:
        "Browse the vegetables or herbs collection, compare heirloom tomatoes and peppers, and open a product page for pack details and pricing.",
    },
    {
      step: "03",
    ...
    },
    {
      ...
      description:
        "Follow DIY project guides and how-to-grow articles, find a local retailer for add-ons, and return next season for the next planting cycle.",
    },
  ],
  adminHighlights: [
    "Shopify product catalogue with collection hierarchy across herbs, vegetables, and seasonal picks",
    "Blog hubs for garden fundamentals, how-to-grow guides, and DIY projects",
    "Bonnie Rewards loyalty programme integration",
    "New gardeners, container gardening, and edible landscaping landing pages",
    "Find a Retailer and contact support flows",
    "Homepage seasonal modules and featured product carousels managed through Shopify",
  ],
  techStack: [
    "Shopify",
    "Custom theme",
  ...
  results: [
    { metric: "100+", label: "years of heritage" },
    { metric: "100s", label: "plant varieties" },
    { metric: "DTC + retail", label: "omnichannel" },
