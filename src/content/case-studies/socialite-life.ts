...
export const socialiteLifeCaseStudy: CaseStudyDetail = {
  slug: "socialite-life",
  liveUrl: "https://socialitelife.com/",
  ...
  stats: [
    { metric: "Since 2003", label: "pop culture coverage" },
    { metric: "Daily", label: "publishing cadence" },
    { metric: "Multi-format", label: "news & interviews" },
    { metric: "Social-first", label: "sharing ready" },
  ],
  featureBandMatch: "article",
  sections: {
    ...
    featuresIntro:
      "Editorial templates, category discovery, and social sharing built as one publishing experience.",
    journeyEyebrow: "Reader journey",
    journeyTitle: "From headline to next story.",
    journeyIntro:
    ...
    ctaIntro:
      "We build content sites with the editorial templates, category depth, and mobile experience media brands actually need.",
  },
  screenshots: [
    {
      src: "/work/socialite-life/homepage.png",
      alt: "Socialite Life homepage with celebrity news hero and latest stories",
      caption: "Homepage",
    ...
    },
    {
      ...
      alt: "Socialite Life entertainment category archive with article grid",
    ...
    },
    {
      ...
      alt: "Socialite Life article page with headline, hero image, and story body",
      caption: "Article",
    ...
    },
    {
      ...
      alt: "Socialite Life blog archive with latest posts listed",
      caption: "Latest",
    ...
    },
    {
      ...
      alt: "Socialite Life interviews category with Q&A and profile articles",
      caption: "Interviews",
    ...
    },
    {
      ...
      alt: "Socialite Life about page with editorial team masthead",
      caption: "About",
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Font resizing, clear headline hierarchy, and comfortable line lengths for long-form interviews and news analysis on any screen size.",
    },
    {
      icon: "referral",
    ...
    },
    {
      ...
      description:
        "Share prompts on every article so readers can spread stories back to the social feeds where entertainment news is discovered.",
    },
    {
      icon: "compliance",
      title: "Legal & contact pages",
      description:
        "About, contact, terms, and privacy pages that establish editorial credibility and meet publishing compliance requirements.",
    },
    {
      icon: "admin",
      title: "High-volume publishing",
      description:
        "WordPress editorial workflows that support multiple contributors, daily story volume, and franchise scheduling without developer involvement.",
    },
  ],
  playerSteps: [
    {
    ...
    },
    {
      ...
      description:
        "Open an article with fast-loading imagery and readable body copy, skim highlights, and share the post if it hits the right note.",
    },
    {
      step: "03",
      title: "Browse related content",
      description:
        "Follow related stories, jump into a category archive, or dive into a franchise tag like Socialite Seven or Celeb Snaps.",
    },
    {
      step: "04",
      title: "Return for more",
      description:
        "Come back via the latest feed or trending sidebar, bookmark favourite franchises, and keep scrolling as new stories publish throughout the day.",
    },
  ],
  adminHighlights: [
    "WordPress editorial dashboard with category and tag taxonomies for franchises",
    "Article templates with hero images, bylines, highlights, and share modules",
    "Homepage hero and trending widgets managed through the CMS",
    "Interview and Q&A formats for the Socialite Seven series",
    "About, contact, terms, and privacy pages editable without code",
    "Performance-tuned theme for high daily traffic and social referral spikes",
  ],
  techStack: [
    "WordPress",
    "Custom theme",
  ...
  results: [
    { metric: "20+", label: "years publishing" },
    { metric: "Daily", label: "story volume" },
    { metric: "Multi-franchise", label: "editorial columns" },
    { metric: "Social-first", label: "reader acquisition" },
  ],
};
