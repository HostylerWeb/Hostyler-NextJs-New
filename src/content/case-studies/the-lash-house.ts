...
export const theLashHouseCaseStudy: CaseStudyDetail = {
  slug: "the-lash-house",
  liveUrl: "https://thelashhouselb.com/",
  ...
  stats: [
    ...
    { metric: "Every curl", label: "length & thickness" },
    { metric: "Variable", label: "lash tray options" },
    { metric: "Lebanon", label: "nationwide delivery" },
  ],
  featureBandMatch: "shop",
  sections: {
    ...
    featuresIntro:
      "Product discovery, variable lash trays, and account tooling built as one WooCommerce experience.",
    journeyEyebrow: "Shopping journey",
    journeyTitle: "From browse to stocked kit.",
    journeyIntro:
    ...
    ctaIntro:
      "We build product-led storefronts with the category depth, variant selectors, and mobile experience specialist retailers actually need.",
  },
  screenshots: [
    {
      src: "/work/the-lash-house/homepage.png",
      alt: "The Lash House homepage with hero messaging and new arrival lash trays",
      caption: "Homepage",
    ...
    },
    {
      ...
      alt: "The Lash House shop page with product grid and filters",
      caption: "Shop",
      title: "Full product catalogue",
      description:
        "The main shop page with sidebar price filters, stock-status toggles, grid density controls, sort options, and a product grid spanning lashes, palettes, organizers, and professional tools.",
    },
    {
      src: "/work/the-lash-house/product.png",
      alt: "The Lash House Cashmere Silk lash tray product page with variant selectors",
    ...
    },
    {
      ...
      alt: "The Lash House lashes category with tray product grid",
      caption: "Lashes",
    ...
    },
    {
      ...
      alt: "The Lash House about page with brand story for lash artists",
      caption: "About",
    ...
    },
    {
      ...
      alt: "The Lash House contact page with message form and contact details",
      caption: "Contact",
  ...
  features: [
    ...
    {
      icon: "wallet",
      title: "Variable lash trays",
      description:
        "Curl, length, and thickness selectors on tray products so artists configure exactly what they need before adding to cart.",
    },
    {
      icon: "instant",
    ...
    {
      icon: "account",
      title: "Accounts & wishlists",
      description:
        "Login, registration, order history, and wishlist support so repeat customers can reorder favourites without searching again.",
    },
    {
      icon: "referral",
    ...
    },
    {
      ...
      description:
        "Dedicated track-my-order page so customers can follow shipments without emailing support for every update.",
    },
    {
      icon: "compliance",
  ...
  playerSteps: [
    {
      ...
      description:
        "Land from Instagram, TikTok, or search, browse new arrivals and category tiles, and understand the range before diving into a specific tray type.",
    },
    {
      step: "02",
      title: "Find your trays",
      description:
        "Filter the lashes category by price and stock, compare Classic, Volume, and Easy Fan options, and open a product page to pick curl and length.",
    },
    {
      step: "03",
    ...
    },
    {
      ...
      description:
        "Track the order, save favourites to a wishlist, and return for the next restock cycle with the same category shortcuts and search.",
    },
  ],
  adminHighlights: [
    "WooCommerce product catalogue with variable attributes for curl, length, and thickness",
    "Category hierarchy across lashes, adhesives, tools, accessories, and salon setup",
    "Homepage carousels and category tiles managed through WordPress",
    "Shipping, returns, FAQ, and contact pages editable without code",
    "Newsletter integration with first-order discount messaging",
    "Social links for Instagram, TikTok, and WhatsApp in header and footer",
  ],
  techStack: [
    "WordPress",
    "WooCommerce",
  ...
  results: [
    { metric: "5", label: "product departments" },
    { metric: "100+", label: "SKUs catalogued" },
    { metric: "Mobile-first", label: "shopping UX" },
    { metric: "Lebanon", label: "delivery coverage" },
  ],
};
